  ...
  de: {
    ...
    pages: {
      ...
      partners: {
        ...
        partnerDescriptions: {
          "1": "Aptean (ehem. Ramsauer & Stürmer) gehört zu den Big Playern am österreichischen Software- und Beratungsmarkt und verfolgt seit seiner Gründung 1984 das Ziel, seinen Kunden die bestmögliche betriebswirtschaftliche Software zu bieten. Apteans ERP-Systeme zählen heute zu den fortschrittlichsten Lösungen am Markt und umfassen unter anderem Module für die Bereiche Rechnungswesen, Personalwesen, Einkauf, Lagerhaltung, Auftragsverwaltung u.v.m. Neben der Software bietet Aptean seinen Kunden umfassende Beratung an der Schnittstelle von Business und IT und begleitet sie so individuell bei ihrer ERP-Customer-Journey. ",
          "2": "Miragon ist eine Boutique-Beratung, die sich auf Geschäftsprozessmanagement, Process Mining und Prozessautomatisierung spezialisiert hat. Das Unternehmen mit Sitz im schönen Augsburg verfügt über umfassende Erfahrung in der Unterstützung von Unternehmen aller Größenordnungen bei der Digitalisierung deiner Prozesse, der Aufdeckung von Ineffizienzen und dem Aufbau eigener Kompetenzen im modernen Prozessmanagement. Wir sind stolz darauf, sie als Technologie- und Implementierungspartner zu haben, der unseren Kunden hilft, den bestmöglichen Platz für die Implementierung von Process Mining in deinem Unternehmen zu finden und dich auf deinem Weg zur gesteigerten Prozessmanagement-Maturity begleitet.",
          "3": "Führender Cloud-Anbieter, der skalierbare und zuverlässige Infrastrukturlösungen liefert.",
          "4": "Die WAITS Software- und Prozessberatungsgesellschaft mbH ist ein innovatives Technologieunternehmen, das sich auf die Entwicklung von effizienten, sicheren und nachhaltigen Lösungen spezialisiert hat. Das Team besteht aus erfahrenen Experten, die sich darauf konzentrieren, moderne Technologien einzuführen, die den Bedürfnissen der Kunden gerecht werden. Seit 1999 profitieren die Kunden in der DACH-Region durch die Mitarbeit in IT-Projekten. Als Fulfiller steht die WAITS nicht nur beratend zur Seite, sondern legt in jeder Phase auch Hand an.",
          "5": "Die Nexigo GmbH ist ein etabliertes Beratungsunternehmen mit Sitz in Deutschland, das sich seit mehr als zwei Jahrzehnten auf die digitale Transformation von Geschäftsprozessen spezialisiert hat. Mit tiefgehender Expertise in den ERP-Systemen Oxaion und Odoo unterstützt Nexigo Unternehmen bei der Analyse, Gestaltung und technologischen Umsetzung komplexer Prozessanforderungen. Das Team vereint langjährige Projekterfahrung mit technischem Know-how und legt besonderen Wert auf eine enge Zusammenarbeit mit seinen Kunden. Dabei stehen nachhaltige, flexible und praxistaugliche Lösungen im Mittelpunkt, die über die reine Softwareimplementierung hinausgehen. Nexigo begleitet den gesamten Transformationsprozess, von der Anforderungsanalyse über die Systemintegration bis hin zur kontinuierlichen Optimierung im laufenden Betrieb.",
          "6": "Die BOC Group ist ein führender Anbieter von innovativer Enterprise-Modelling-Software, das Unternehmen bei der Optimierung von Geschäftsprozessen und der digitalen Transformation unterstützt. Ihre Flaggschifflösungen – ADONIS für Business Process Management, ADOIT für Enterprise Architecture und ADOGRC für Governance, Risk & Compliance – sind für ihre Anpassungsfähigkeit und nahtlose Integration mit verschiedenen Systemen bekannt. Mehr als 1.500 Kunden auf der ganzen Welt, von KMUs bis hin zu Fortune-500-Unternehmen, vertrauen auf die Produkte der BOC Group, die sich durch ihr Engagement für die Bereitstellung benutzerfreundlicher Tools zur Bewältigung komplexer geschäftlicher Herausforderungen auszeichnen. Mit ihrem Fokus auf Innovation und Kundenorientierung ist sie ein geschätzter Partner für Unternehmen, die sich dem digitalen Zeitalter stellen.",
          "7": "Die Wiener Beratung Vienesse Consulting ist ein aufstrebendes Unternehmen mit dem Ziel, ihre Kunden durch die Prozess- und Datenaspekte der digitalen Transformation zu begleiten. Mit einem Fokus auf den Aufbau einer Datenkultur, um datengetriebene Entscheidungsfindung zu ermöglichen, befähigt Vienesse ihre Kunden state of the Art Techniken sowie Tools einzusetzen. Zentraler Aspekt bei diesen Transformationen ist der Aufbau einer Kultur der Transparenz und des Vertrauens im Umgang mit diesen hoch disruptiven Vorgehensmodellen. Mit unserer Technologie nutzt Vienesse ihre Fähigkeiten, um gemeinsamen Kunden dabei zu helfen, die Erkenntnisse, die unsere Lösungen bieten, bestmöglich zu verwerten. Dabei wird genau identifiziert, welche Art von Change Management und Prozessanpassungen notwendig sind, um sicherzustellen, dass die identifizierten Potenziale nachhaltig und auf Ursachenebene in einen gesteigerten Unternehmenswert umgewandelt werden.",
          ...
          "12": "Das PwC-Scale-Programm bietet eine Plattform zum Austausch zwischen Startups, Corporates und Investoren. Als Teil dieses prestigeträchtigen Netzwerks sind wir stolz darauf in der B2B-Tech-Cohorte aufgenommen worden zu sein. Diese Teilnahme ermöglicht es uns, unsere Vision und Technologien einem breiteren Publikum vorzustellen und gleichzeitig von der umfangreichen Expertise und den Ressourcen von PwC zu profitieren. Durch diese Zusammenarbeit streben wir danach, unsere Lösungen weiterzuentwickeln und maßgeschneiderte Innovationen zu liefern, die den Anforderungen unserer Kunden gerecht werden.",
          "13": "Die Humboldt-Innovation vernetzt Wissenschaft, Wirtschaft und Gesellschaft mit Dienstleistungen in den Bereichen angewandte Forschung, Unternehmensgründung und Veranstaltungen. Als 100%ige Tochtergesellschaft der Humboldt-Universität zu Berlin verfolgen sie das Ziel, Forschung, Innovationen und Ressourcen verfügbar zu machen. Noreja ist als Humboldt-Startup gelistet. Hier gibt es dazu mehr Information.",
          "14": "Die Wirtschaftsuniversität Wien ist mit mehr als 23.000 Studierenden aus dem In- und Ausland die größte Wirtschaftsuniversität in Europa. 2.100 MitarbeiterInnen arbeiten ständig daran, die Qualität von Lehre, Forschung und Campusleben voranzutreiben und sich damit einen Platz unter den weltweit herausragenden Universitäten zu verdienen und zu erhalten. Mit der Dreifach-Akkreditierung, bestehend aus EQUIS, AACSB und AMBA, den wichtigsten internationalen Akkreditierungen für Wirtschaftsuniversitäten, ist die WU eine von nur zwei Universitäten im deutschsprachigen Raum, die zu diesem exklusiven Kreis gehören. Weltweit erfüllen weniger als 1% aller Universitäten die hohen Qualitätsstandards für alle drei Akkreditierungen. Noreja ist ein Spin-off aus dem Institut für Daten-, Prozess- und Wissensmanagement. Es forscht in diesem Bereich mit den Schwerpunkten Geschäftsprozessmanagement, Wissensmanagement, Entscheidungsunterstützungssysteme und Semantisches Web.",
