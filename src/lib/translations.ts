  ...
  en: {
    ...
    pages: {
      ...
      useCases: {
        "supply-chain": {
          title: "Supply Chain",
          shortDescription: "Optimize logistics and distribution processes",
          description: "Transform your supply chain operations with Noreja Process Intelligence. Gain visibility into every step of your logistics processes, identify bottlenecks, and optimize distribution networks for maximum efficiency.",
          sections: [
            {
        ...
        "manufacturing": {
          title: "Manufacturing",
          shortDescription: "Enhance production efficiency and quality control",
          description: "Streamline manufacturing operations with process intelligence. Monitor production workflows, optimize resource allocation, and ensure consistent quality across all manufacturing processes.",
          sections: [
            {
        ...
        "insurance": {
          title: "Insurance",
          shortDescription: "Streamline claims processing and risk assessment",
          description: "Transform insurance operations with intelligent process analysis. Accelerate claims processing, improve risk assessment accuracy, and enhance customer experience through optimized workflows.",
          sections: [
            {
        ...
        "banking": {
          title: "Banking",
          shortDescription: "Optimize financial operations and compliance",
          description: "Enhance banking operations with process intelligence. Improve loan processing, optimize compliance workflows, and deliver better customer experiences through streamlined financial processes.",
          sections: [
            {
  ...
  de: {
    ...
    pages: {
      ...
      useCases: {
        "supply-chain": {
          title: "Supply Chain",
          shortDescription: "Logistik- und Distributionsprozesse optimieren",
          description: "Transformiere deine Supply-Chain-Operationen mit Noreja Process Intelligence. Erhalte Transparenz in jeden Schritt deiner Logistikprozesse, identifiziere Engpässe und optimiere Distributionsnetzwerke für maximale Effizienz.",
          sections: [
            {
        ...
        "manufacturing": {
          title: "Produktion",
          shortDescription: "Produktionseffizienz und Qualitätskontrolle verbessern",
          description: "Optimiere Produktionsprozesse mit Process Intelligence. Überwache Produktionsabläufe, optimiere Ressourcenzuteilung und stelle konsistente Qualität in allen Produktionsprozessen sicher.",
          sections: [
            {
        ...
        "insurance": {
          title: "Versicherung",
          shortDescription: "Schadensbearbeitung und Risikobewertung optimieren",
          description: "Transformiere Versicherungsoperationen mit intelligenter Prozessanalyse. Beschleunige Schadensbearbeitung, verbessere Risikobewertungsgenauigkeit und verbessere Kundenerfahrungen durch optimierte Workflows.",
          sections: [
            {
        ...
        "banking": {
          title: "Banking",
          shortDescription: "Finanzoperationen und Compliance optimieren",
          description: "Verbessere Bankoperationen mit Process Intelligence. Verbessere Kreditbearbeitung, optimiere Compliance-Workflows und liefere bessere Kundenerfahrungen durch optimierte Finanzprozesse.",
          sections: [
            {
