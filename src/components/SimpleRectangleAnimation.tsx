...
const SimpleRectangleAnimation = () => {
  ...
  return (
    <>
      ...
      {/* Sticky card stack section - wraps both sticky viewport and step sentinels */}
      <section id="sticky-stack" className="relative h-[500vh] bg-gradient-to-br from-noreja-main/5 to-noreja-main/10">
        {/* Sticky viewport that pins while scrolling through sentinels */}
        <div className="sticky top-0 w-full h-screen flex flex-col items-center justify-center overflow-hidden z-10">
          ...
          >
            ...
            <motion.div
              ...
              style={{ 
                display: reducedMotion && animationStep !== 0 ? 'none' : undefined,
            ...
            <motion.div
              data-active={animationStep === 1 ? "true" : undefined}
              aria-hidden={animationStep !== 1}
              className="absolute w-2/4 h-full backdrop-blur-md rounded-xl shadow-2xl text-center"
              style={{ 
                display: reducedMotion && animationStep !== 1 ? 'none' : undefined,
            ...
            <motion.div
              data-active={animationStep === 2 ? "true" : undefined}
              aria-hidden={animationStep !== 2}
              className="absolute w-2/4 h-full backdrop-blur-md rounded-xl shadow-2xl text-center"
              style={{ 
                display: reducedMotion && animationStep !== 2 ? 'none' : undefined,
            ...
            <motion.div
              data-active={animationStep === 3 ? "true" : undefined}
              aria-hidden={animationStep !== 3}
              className="absolute w-2/4 h-full backdrop-blur-md rounded-xl shadow-2xl text-center"
              style={{ 
                display: reducedMotion && animationStep !== 3 ? 'none' : undefined,
      ...
      {/* Final section with conclusion text */}
      <div className="h-screen flex items-center justify-center bg-gradient-to-br from-noreja-main/5 to-noreja-main/10">
        <div className="text-center">
          <motion.h2 
